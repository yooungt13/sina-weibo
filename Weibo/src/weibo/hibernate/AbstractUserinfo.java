...
public abstract class AbstractUserinfo implements java.io.Serializable {
	...
	private Set followGroups = new HashSet(0);
	private Set counts = new HashSet(0);
	...
	/** minimal constructor */
	public AbstractUserinfo(Login login, String nickName, String province,
			String city, String sex, Timestamp regTime) {
		this.login = login;
	...
	/** full constructor */
	public AbstractUserinfo(Login login, String nickName, String trueName,
	...
	public Set getFollowGroups() {
		return this.followGroups;
	}

	public void setFollowGroups(Set followGroups) {
		this.followGroups = followGroups;
	}

	public Set getCounts() {
		return this.counts;
	}

	public void setCounts(Set counts) {
		this.counts = counts;
	}
	...
	public int getCommentCount() {
		CommentServ comServ = ServiceLocator. getCommentServ();
		return comServ.getCommentByUser().size();
	}
	...
	public String getHiddenID() {
		hiddenID = identifier.substring(0,3) + "***********" + identifier.substring(identifier.length()-4, identifier.length());
		return hiddenID;
	}
	...
	public boolean getAck(){
		...
		fansList = (ArrayList<FansManage>) fmDao.findByFansId(user.getUserId());
		for(int i=0;i<fansList.size();i++)
		{ 
            int followId = fansList.get(i).getFollowId();
